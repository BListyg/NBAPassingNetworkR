...
playoff.data.P <- getPLAYERdata(season = '2013-14',season.type = 'Playoffs')
...
reg.data.T <- getTEAMdata(season = '2013-14',season.type = 'Regular+Season')
playoff.data.T <- getTEAMdata(season = '2013-14',season.type = 'Playoffs')

#####

#write.csv(x = playoff.data.P, "playoffs_player_data201718.csv")
#write.csv(x = playoff.data.T, "playoffs_team_data201718.csv")
...
x <- playoff.data.P$PLAYER_ID_GAME_DATE
...
# 
# for(i in 1:200){
#   retry(query(x[i]), maxErrors=10, sleep=0)
#   print(i)
# }
